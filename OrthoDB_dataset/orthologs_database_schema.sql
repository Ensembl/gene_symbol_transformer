...
/*
SQL schema for the [OrthoDB](https://www.orthodb.org/) release files derived database.

MySQL style SQL that is compatible with SQLite is being used.

release files: https://www.orthodb.org/?page=filelist
